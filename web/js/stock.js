...
function data_filter(){
    ...
    var banq = document.getElementById("banq_select").value;
    var sel = document.getElementById("banq_select");
    var bq_name = sel.options[sel.selectedIndex].innerHTML;

    $.get("AdminStatistiques", {"ville":ville, "banq":banq, "action":"filter"} , function (data){
